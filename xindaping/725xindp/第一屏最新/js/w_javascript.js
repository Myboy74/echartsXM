...
//      $('.wangchao').eq(sum).stop(true,true).show().siblings('.wangchao').hide()
    ...
    $('.w_tipbar_l li').mouseover(function(){
...
/**性别年龄(性别)**/
function sexls(){
    var chart = echarts.init(document.getElementById('l_nian2'));
    option = {
        title: {
        },
...
/**性别年龄(年龄)**/
function sex2s(){
    var chart = echarts.init(document.getElementById('l_nian'));
    option = {
        title: {
        },
        backgroundColor: 'rgba(255,255,255,0)',
...
/**性别年龄(学历)**/
function sex3s(){
    var chart = echarts.init(document.getElementById('l_nian3'));
    option = {
        title: {
        },
        backgroundColor: 'rgba(255,255,255,0)',
...
//   WEB/APP/微信访问分布饼状图
function lw_pie(){
    var chart = echarts.init(document.getElementById('lw_pie'));
	var ls2_option = 
   [
        {
...
function dangyua(){
    ...
    var w_option = {
        ...
        series: [
            {
                ...
                data: [439219, 662996, 321680, 213740, 114552, 554732,
                    592075, 447460, 347104, 209134, 209786, 96066, 540197,
                    274637, 297992, 231785, 371257, 95243, 55010, 35061,
                    54623, 9841, 1244
                ],
            },
            {
                ...
                data: [24560, 40171, 8172, 6750, 2217, 7233, 4069,
                    31375, 29390, 11781, 10242, 1484, 33674, 17043,
                    13940, 3220, 1739, 37444, 9944, 2751, 57341, 9424, 1801
                ],
            },
            {
                itemStyle: {
      ...
      $.getJSON('bigScreen/注册党员23省属党员注册分布.json', function(res) {
    	w_option.series[0].data=res.value;
    	w_option.series[1].data=res.weizhuce;
    	w_option.series[2].data=res.zhucelv;
