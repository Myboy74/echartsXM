...
//      $('.wangchao').eq(sum).stop(true,true).show().siblings('.wangchao').hide()
    ...
    // 组工网管理员在线数切换
    $('#l_qus').html('组工干部在线管理员情况')
    $('#l_tipbar_w li').mousemove(function(){
    	 $(this).addClass('active_bar').siblings().removeClass('active_bar')
    	 var sum=$(this).index();
    	 if(sum>0){
    	 	$('#l_qus').html('全省管理员情况')
    ...
    $('#l_tipbak li').mouseenter(function(){
    	
    	 $(this).addClass('active_bar').siblings().removeClass('active_bar')
    	 var sum=$(this).index();
    	 if($(this).html()=='组工干部在线管理员24小时在线分布情况'){
    	 	 mksd(0);
    	 }else {
    	 	 mksd(1);
    	 }
      ...
      // 组工网管理员在切换切换
     $('#l_tipbars li').mouseenter(function(){
    	 $(this).addClass('active_bar').siblings().removeClass('active_bar')
    	 var sum=$(this).index();
    	 if($(this).html()=='组工干部在线管理员配备情况'){
    	 	l_gls(1,'#4a89dc','#967adc');
    	 }else {
    	 	l_gls(0,'#d770ad','#4a89dc');
    	 }
    })
    //地图切换
    $('.counter').countUp();
...
//	 省委直属党(工)委所属党组织管理员24小时人员分布 (单位:人)
	l24_option = {
    title: {
        text: '',
         textStyle: {
...
if(id>0){
	 $.getJSON('bigScreen/各时间段在线管理员人数.json',function(res){  	
        ...
        l24_option.title.text='省委直属党(工)委所属党组织管理员24小时人员分布 (单位:人)'
...
chart.setOption(l24_option);
	 ...
	 $.getJSON('bigScreen/各时间段在线管理员人数.json',function(res){  	
        ...
        l24_option.title.text='组工网在线管理员24小时人员分布 (单位:人)'
        l24_option.xAxis.data=times
        l24_option.series[0].itemStyle.normal.color=new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                            offset: 0,
                            color: 'rgba(72,207,174,1)'
                        }, {
                            offset: 1,
        ...
        l24_option.series[0].areaStyle.normal.color=new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                        offset: 0,
