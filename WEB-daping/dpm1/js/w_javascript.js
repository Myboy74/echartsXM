...
myChart_age.setOption(option_lkj);
};
w_ages();
// 工作岗位
function w_gangweis(){
    ...
    series: [
        {
          ...
          selectedMode: 'single',
          radius: ['40%', '58%'],
          color: ['#967adc','#ac92ec','#4a89dc','#37bc9b','#da4453','#ffce54'],
            label: {
            normal: {
                formatter: '{b}\n{d}%',
    ...
    series: [
        {
          ...
          selectedMode: 'single',
          radius: ['40%', '58%'],
          color: ['#8cc152', '#37bc9b', '#3bafda', '#4a89dc','#f6bb42',],
            label: {
            normal: {
                formatter: '{b}\n{d}%',
    ...
    series: [{
        ...
        itemStyle: {
            normal: {
                ...
                borderColor: 'rgba(242,168,49,0.27)',
                borderWidth: 12
    ...
    series : [
        {
            ...
            type:'bar',
            stack: 'sum',
            data: [60, 70, 80, 99, 65, 78, 78,
                    89, 66, 78, 86, 87, 80, 84, 83,
                    87, 77, 38, 90, 96, 80, 99, 97
                ],
            barWidth:10,
            barBorderRadius:15,
            barGap:20
...
option = {
   ...
   height:'170px',
    ...
    series: [{
        ...
        data:  [7372, 1995, 1705, 2265, 4132, 7135, 4132],
    }]
};
			chart.setOption(option);
}
